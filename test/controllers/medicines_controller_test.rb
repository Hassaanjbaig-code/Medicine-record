...
class MedicinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicine" do
    assert_difference("Medicine.count") do
      post medicines_url, params: { medicine: { medicine_mg: @medicine.medicine_mg, medicine_name: @medicine.medicine_name, use_for: @medicine.use_for } }
    end
  ...
  test "should update medicine" do
    patch medicine_url(@medicine), params: { medicine: { medicine_mg: @medicine.medicine_mg, medicine_name: @medicine.medicine_name, use_for: @medicine.use_for } }
